...
public class Class9Utility {
    ...
    public String msg(){
        String question = "Merits Unitary Form of Government";
        ...
        PromptTemplate promptTemplate = PromptTemplate.from(
                "You work as an teacher at the School. Frame few questions to the best of your ability in topic :\n"
                        + "{{topic}}\n" +
                        "\n"
    ...
    {
        Document document = loadDocument(toPath("9Social.pdf"),new ApachePdfBoxDocumentParser());
